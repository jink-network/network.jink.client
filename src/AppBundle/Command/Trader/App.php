...
class App
{
                                ...
                                $jinkClientId = null)
    {
        ...
        try {
            ...
            $log = new Log("Binance - ignoring: ",Log::LOG_LEVEL_INFO);
            $this->getJink()->postLog($log);
        ...
        try {
            ...
            $log = new Log("Bittrex - ignoring",Log::LOG_LEVEL_INFO);
            $this->getJink()->postLog($log);
        ...
        try {
            ...
            $log = new Log("Kucoin - ignoring: ".get_class($e).' : '.$e->getMessage(),Log::LOG_LEVEL_INFO);
            $this->getJink()->postLog($log);
